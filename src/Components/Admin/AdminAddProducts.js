        ...
        <div>
            <Row className="justify-content-start ">
                ...
                <Col sm="8">
                    ...
                    />
                    <div className="text-form pb-2">صورة غلاف المنتج</div>
                    <input
                        onChange={handleImageCoverSelect}
                        type='file'
